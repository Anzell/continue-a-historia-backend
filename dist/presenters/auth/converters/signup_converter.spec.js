...
describe('signup converter', function () {
    it('should return a valid object', function () {
        ...
        expect(result).toStrictEqual(either_ts_1.right({ username, password, email }));
    });
    it('should return a left if data passed is invalid', function () {
        ...
        expect(result).toStrictEqual(either_ts_1.left(new failures_1.ValidationFailure({ message: signup_converters_1.SignupConverterErrorMessages.missingUsername })));
        ...
        expect(result).toStrictEqual(either_ts_1.left(new failures_1.ValidationFailure({ message: signup_converters_1.SignupConverterErrorMessages.missingPassword })));
        ...
        expect(result).toStrictEqual(either_ts_1.left(new failures_1.ValidationFailure({ message: signup_converters_1.SignupConverterErrorMessages.missingEmail })));
    });
});
